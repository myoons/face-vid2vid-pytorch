...
class FaceVgg(nn.Module):
    ...
    def __init__(self, requires_grad=False, weight_dir='pretrained/face_vgg.pth'):
    ...
    def forward(self, x0):
        if x0.shape[2:] != self.meta['imageSize'][:2]:
            x0 = F.interpolate(x0, size=(self.meta['imageSize'][:2]))
