...
def compute_bbox(start, end, fps, tube_bbox, frame_shape, inp, image_shape, increase_area=0.1):
    ...
    # return f'ffmpeg -i {inp} -ss {start} -t {time} -filter:v "crop={w}:{h}:{left}:{top}, scale={scale}" test_crop.mp4'
    return ""
...
if __name__ == "__main__":
    ...
    parser.add_argument("--min_frames", type=int, default=75, help='Minimum number of frames')
